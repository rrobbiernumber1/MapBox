import SwiftUI
import Foundation // cos 함수 사용을 위해 명시적으로 추가
...
struct PinView: View {
    ...
    private struct PinShape: Shape {
        ...
        func path(in rect: CGRect) -> Path {
            ...
            // Foundation의 cos 함수를 명시적으로 사용
            let startPoint = CGPoint(x: circleRadius + circleRadius*Foundation.cos(angle), y: circleRadius + circleRadius * Foundation.sin(angle))
