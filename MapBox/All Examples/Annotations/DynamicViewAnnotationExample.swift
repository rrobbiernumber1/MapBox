...
final class DynamicViewAnnotationExample: UIViewController, ExampleProtocol {
    ...
    private var routes = [Route]() {
        didSet {
            ...
            // Note: We're removing SPI call to viewAnnotationAvoidLayers
            // Instead we'll rely on the standard priority-based approach
    ...
    override func viewDidLoad() {
        ...
        // Removing the SPI property usesSafeAreaInsetsAsPadding
        // Instead, we'll set the viewport options without this property
...
// calloutPath extension is already defined elsewhere in the project
